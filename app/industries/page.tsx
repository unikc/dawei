...
export const metadata={title:"Industries",description:"Valve and piping supply for waterworks, municipal infrastructure, HVAC, fire protection, and industrial projects worldwide."};
