  ...
  return (
    <footer className="bg-navy text-white">
      <div className="mx-auto grid max-w-7xl gap-10 px-5 py-16 md:grid-cols-4">
        <div><b className="text-2xl">DALIAN DAWEI</b><p className="mt-4 text-sm leading-7 text-white/60">Specialized in ductile iron valves, with broader valve and piping supply capabilities for international B2B customers.</p></div>
