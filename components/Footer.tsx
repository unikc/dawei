  ...
  return (
    <footer className="bg-navy text-white">
      <div className="mx-auto grid max-w-7xl gap-10 px-5 py-16 md:grid-cols-4">
        ...
        <div><h3 className="mb-4 text-sm font-bold uppercase tracking-widest text-signal">Start an RFQ</h3><p className="text-sm leading-7 text-white/65">Send your valve list, technical specifications, quantities, and target delivery date.</p><div className="mt-5 grid gap-2 text-sm font-bold"><a className="border border-white/30 px-5 py-3" href="mailto:guogangliu@vip.sina.com">guogangliu@vip.sina.com</a><a className="border border-white/30 px-5 py-3" href="mailto:guogangliu@sina.com">guogangliu@sina.com</a></div></div>
      </div>
